...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video, file, 60, 302, 1346);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 60, 259, 1303);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 60, 70, 1114);
			attr_dev(div0, "class", "content");
			add_location(div0, file, 60, 49, 1093);
			attr_dev(div1, "class", "assets svelte-1f9em6n");
			add_location(div1, file, 60, 173, 1217);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 60, 150, 1194);
		},
		m: function mount(target, anchor) {
...
const preload = async ({ params, query }) => {
	const res = await undefined.fetch(`gallary.json`);
