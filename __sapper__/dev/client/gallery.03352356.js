...
/* src/routes/gallery.svelte generated by Svelte v3.19.2 */

const file = "src/routes/gallery.svelte";
...
class Gallery extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*assets*/ ctx[0] === undefined && !("assets" in props)) {
			console.warn("<Gallery> was created without expected prop 'assets'");
		}
	}
