...
},{}],"assets/avatar_burned2.png":[function(require,module,exports) {
module.exports = "/avatar_burned2.59c018a1.png";
...
var _avatar_burned = _interopRequireDefault(require("../assets/avatar_burned2.png"));
...
function add_css() {
  var style = (0, _internal.element)("style");
  style.id = "svelte-17szayd-style";
  style.textContent = "canvas.svelte-17szayd{margin:0 auto;background-image:var(--avatar);background-size:cover;border-radius:20px;width:200px;height:311px}\n";
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(canvas_1, "class", "svelte-17szayd");
      (0, _internal.add_location)(canvas_1, file, 10, 127, 346);
      (0, _internal.attr_dev)(div0, "class", "column is-narrow");
      (0, _internal.set_style)(div0, "text-align", "center");
      (0, _internal.add_location)(div0, file, 10, 69, 288);
      (0, _internal.attr_dev)(h1, "class", "title is-size-3");
      (0, _internal.add_location)(h1, file, 10, 229, 448);
      (0, _internal.add_location)(br0, file, 10, 337, 556);
      (0, _internal.attr_dev)(p, "class", "subtitle is-size-5");
      (0, _internal.add_location)(p, file, 10, 279, 498);
      (0, _internal.add_location)(br1, file, 11, 40, 601);
      (0, _internal.attr_dev)(icon, "class", "fontello icon-mail-alt");
      (0, _internal.add_location)(icon, file, 11, 122, 683);
      (0, _internal.add_location)(span, file, 11, 166, 727);
      (0, _internal.attr_dev)(a, "class", "has-addons is-bold is-size-5");
      (0, _internal.attr_dev)(a, "href", "mailto:mathiassenmarcus@me.com");
      (0, _internal.add_location)(a, file, 11, 44, 605);
      (0, _internal.attr_dev)(div1, "class", "column is-narrow");
      (0, _internal.set_style)(div1, "text-align", "center");
      (0, _internal.add_location)(div1, file, 10, 171, 390);
      (0, _internal.attr_dev)(div2, "class", "columns is-centered is-vcentered");
      (0, _internal.add_location)(div2, file, 10, 23, 242);
      (0, _internal.attr_dev)(div3, "class", "container");
      (0, _internal.add_location)(div3, file, 10, 0, 219);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      ...
      (0, _internal.append_dev)(div0, canvas_1);
      /*canvas_1_binding*/
      ...
      (0, _internal.append_dev)(div1, br1);
...
function instance($$self, $$props, $$invalidate) {
  ...
  let program;
  let canvas;
  let canvasWidth = 200 * 1;
  let canvasHeight = 311 * 1;
  ...
  (0, _svelte.onMount)(async () => {
    ...
    texture = loadTexture(gl, _avatar_burned.default);
    let frame;
  ...
  return [canvas, focused, startTime, mouse, uniformLoc, texture, devicePixelRatio, vao, gl, program, canvasWidth, canvasHeight, textColors, backColor, normalize, updateValues, getRelativeMousePosition, updateMousePos, canvas_1_binding];
}

class Hero extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-17szayd-style")) add_css();
    (0, _internal.init)(this, options, instance, create_fragment, _internal.safe_not_equal, {});
    (0, _internal.dispatch_dev)("SvelteRegisterComponent", {
      component: this,
      tagName: "Hero",
...
var _default = Hero;
exports.default = _default;
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","../assets/avatar.jpg":"assets/avatar.jpg","../assets/avatar_burned2.png":"assets/avatar_burned2.png","./shaders/blob-avatar.vert":"components/shaders/blob-avatar.vert","./shaders/blob-avatar.frag":"components/shaders/blob-avatar.frag","svelte":"../node_modules/svelte/index.mjs","./utils/math":"components/utils/math.js","./utils/utility":"components/utils/utility.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/repos.svelte":[function(require,module,exports) {
"use strict";
...
function get_each_context(ctx, list, i) {
  ...
  child_ctx[1] = list[i];
  return child_ctx;
} // (14:238) {#each components as component}
...
function create_each_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(div, "class", "column is-half is-narrow");
      (0, _internal.add_location)(div, file, 13, 269, 551);
    },
    m: function mount(target, anchor) {
  ...
  (0, _internal.dispatch_dev)("SvelteRegisterBlock", {
    ...
    id: create_each_block.name,
    type: "each",
    source: "(14:238) {#each components as component}",
    ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.attr_dev)(div2, "class", "columns is-centered");
      (0, _internal.add_location)(div2, file, 13, 205, 487);
      (0, _internal.attr_dev)(div3, "class", "container");
      (0, _internal.add_location)(div3, file, 13, 95, 377);
