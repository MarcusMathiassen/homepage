 ...
 */
export const getMinAndMaxPosition = objects => {
    let min = new v2(10000, 10000)
    let max = new v2(-10000, -10000)
...
export const HSLstringToRGB = hsl => {
...
export const addProgressBar = options => {
    const bar = jq('<input>')
    bar.type = 'range'
...
export const addButton = options => {
    ...
    jq(`#${options.parent}`).appendChild(element)
}
